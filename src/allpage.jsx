    ...
    <div>
      <div className="flex h-screen bg-white">
        ...
        <div className="md:hidden">
          <button onClick={toggleMenu} className="block text-black mt-2 ml-5 ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
            ...
            >
              <path
                ...
                d={
                  isOpen
                    ? "M18 9v2H6l4 4l-1 2l-7-7l7-7l1 2l-4 4z"
          ...
          {isOpen && (
            <div className="flex flex-col w-96 bg-white divide-y">
              <div className="flex flex-col flex-1 overflow-y-auto">
                <nav className="flex-1 px-2 py-4 bg-white">
                  <div className="border-t-[3px] border-gray-300  w-[350px] my-1"></div>
                  <a
                    href="#"
                    className="flex items-center px-4 py-2 text-black hover:bg-gray-100"
                  >
                    ...
                    My Dashbord
                    <svg
                      className="w-3 h-3 text-gray-800  ml-[150px] "
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 8 14"
                  ...
                  <div className="border-t-2 border-gray-300  w-[330px] my-1"></div>
                  <a
                    href="#"
                    className="flex items-center px-4 py-2 mt-2 text-black hover:bg-gray-100"
                  >
                    ...
                    TOTM links
                    <svg
                      className="w-3 h-3 text-gray-800  ml-[165px] "
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 8 14"
                  ...
                  >
                    ...
                    Daily Work Summary
                    <svg
                      className="w-3 h-3 text-gray-800   ml-[95px]"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 8 14"
                  ...
                  >
                    ...
                    Update Bank Details
                    <svg
                      className="w-3 h-3 text-gray-800  ml-[100px]"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 8 14"
        ...
        <hr />
        {/* Main content */}
        <div className="flex flex-col flex-1 overflow-y-auto  md:divide-x-2">
          <div className="flex items-center justify-between h-16  bg-white border-b border-gray-200 ">
            <div className="flex items-center justify-center space-x-28 mt-8  text-lg ">
          ...
          <div className="p-4 mr-8 ">
            ...
            <p className="mt-2 text-black">
              ...
              quibusdam, reprehenderit consectetur molestiae? Vel pariatur
              fugiat fuga laborum nemo labore.
            </p>
          </div>
          <div>
            <div className="pt-4 pb-0 mt-6 lg:mt-0 rounded shadow bg-white border-4 border-gray-100 mx-5 lg:mx-10">
              <form>
                <div className="md:flex mb-4 ml-5">
                  ...
                  <div className="md:w-2/3 mr-10">
                    <input
                      className="form-input block w-full bg-white border border-gray-300 rounded-md focus:bg-customGray"
                      id="my-textfield"
                      type="text"
                ...
                <div className="md:flex mb-4">
                  ...
                  <div className="md:w-2/3 mr-10 ml-4">
                    {!isChecked ? (
                      <div className="flex items-center bg-white mb-2 border border-gray-300 rounded-md p-3">
                        <input
                          type="checkbox"
                          id="consent-checkbox"
                        ...
                        >
                          ...
                          elit. Temporibus sed beatae esse blanditiis odit error
                          ex animi quia, doloribus quae.
                        </label>
                      </div>
                    ) : (
                      <>
                        <div className="flex flex-col items-center bg-customGray  border border-gray-300 rounded-md p-3">
                          <label
                            className="ml-5 text-gray-700 font-medium"
                            htmlFor="consent-checkbox"
                          >
                ...
                <div className="md:flex md:items-center">
                  ...
                  <div className="md:w-1/3 flex justify-end mr-8">
                    <a href="/Otp">
                      {" "}
                      <button
                        className="shadow bg-green-700 hover:bg-yellow-500 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mb-4"
                        type="button"
                      >
                        Save
                      </button>
            ...
            <div className="pt-4 pb-0 mt-6  lg:mt-0  bg-white  mx-5 lg:mx-10">
              <p className="uppercase text-center mb-1">
